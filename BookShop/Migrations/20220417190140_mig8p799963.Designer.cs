...
namespace BookShop.Migrations
{
    ...
    [Migration("20220417190140_mig8p799963")]
    partial class mig8p799963
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookShop.Models.Translator_Book", b =>
                {
                    ...
                    b.Property<int?>("translatorIdTranslator_Id")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("translatorIdTranslator_Id");
            ...
            modelBuilder.Entity("BookShop.Models.Translator_Book", b =>
                {
                    b.HasOne("BookShop.Models.Book", "bookId")
                        .WithMany("translator_Books")
                        .HasForeignKey("BookId");

                    b.HasOne("BookShop.Models.Translator", "translatorId")
                        .WithMany("translator_Books")
                        .HasForeignKey("translatorIdTranslator_Id");

                    b.Navigation("bookId");

                    b.Navigation("translatorId");
                });
